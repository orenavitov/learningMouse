...
if __name__ == '__main__':
    ...
    _X = get_test_matrix(X, 0.7)
    # replace 0 with np.nan
    # X[X == 0] = np.nan
    print(X)
    # np.random.seed(1)
    mf = MF(X, k=2, alpha=0.1, beta=0.1, iterations=50)
    mf.train()
    ...
    print(X_comp)
    print(X)
    X_hat_file = r"C:\Users\mihao\Desktop\米昊的东西\X_hat_file.txt"
    X_comp_file = r"C:\Users\mihao\Desktop\米昊的东西\X_comp_file.txt"
    X_file = r"C:\Users\mihao\Desktop\米昊的东西\X_file.txt"
    write_matrix(X_hat, X_hat_file)
    # write_matrix(X_comp, X_comp_file)
    # write_matrix(X, X_file)